...
Finally, related to the [path analysis](#path-analysis) section, we classify links into two types: social circle and theme. Themed links can be further differentiated into two sub-categories:
